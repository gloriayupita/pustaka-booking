            ...
            <div class="col-sm-3 col-md-3">
                <div class="thumbnail" style="height: auto; position: relative; left: 100%; width: 200%;">
                    ...
                    <div class="caption">
                        ...
                        <p>
                            <a class="<button type = 'button' class='btn btn-outline-primary'><i class = 'fas fw fa-shopping-cart'></i>Booking&nbsp;&nbsp 0</button>" href="<?= base_url('booking/tambahBooking/' . $id); ?>"> Booking</a>
